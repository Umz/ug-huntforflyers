...
const Stage5MasjidModel = {
    ...
    BUILDINGS: [
        ...
        Building.New(Decor.BARREL).setTileX(91.5).setDepth(Depths.DECOR_FG),
        Building.New(Decor.BARREL).setTileX(92).setDepth(Depths.DECOR_FG),
    ],
    ...
    FORESTS: [
        ...
        Forest.New().setTileX(82).setSize(5)
            .addLayer([PlantType.FLOWER1, PlantType.FLOWER2, PlantType.FLOWER3], Depths.FOREST_BG3)
            .addLayer([PlantType.FLOWER1, PlantType.FLOWER2, PlantType.FLOWER3], Depths.FOREST_FG1),

        Forest.New().setTileX(84).setSize(12)
            .addLayer([PlantType.TREE3, PlantType.TREE3_RED], Depths.BUILDINGS_BEHIND),

        Forest.New().setTileX(83.5).setSize(3).setEnemy(RedBirdModel)
            .addLayer([ PlantType.TREE3_YELLOW], Depths.FOREST_BG3),
        Forest.New().setTileX(93.5).setSize(3).setEnemy(RedBirdModel)
            .addLayer([ PlantType.TREE3_YELLOW], Depths.FOREST_BG3),

        Forest.New().setTileX(91).setSize(6)
            .addLayer([PlantType.FLOWER1, PlantType.FLOWER2, PlantType.FLOWER3], Depths.FOREST_BG3)
            .addLayer([PlantType.FLOWER1, PlantType.FLOWER2, PlantType.FLOWER3], Depths.FOREST_FG1),
    ]
}
export default Stage5MasjidModel;